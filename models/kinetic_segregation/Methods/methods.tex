...
The model is implemented in C (C11) with optional GPU acceleration via
Apple Metal on Apple Silicon.  A single binary (\texttt{ks\_gpu})
provides both CPU and GPU execution modes.
