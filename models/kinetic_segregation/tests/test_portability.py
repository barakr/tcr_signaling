...
# The `__main__.py` relative-import rule used to be checked here for this
# model only. It now lives in test_model_contract.py, which applies it to
# every model and uses the AST rather than a substring scan — one rule, one
# guard, and the next model inherits it.
